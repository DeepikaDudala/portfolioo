				...
				<Row className="justify-content-center align-items-center ms-4">
					<Col md={6}>
						...
						<div className="justify-content-center align-items-center ms-lg-3 ps-lg-4">
							<span className="">
								passionate about learning and driven by challenges. Proficient in
								Java and Python, with a robust background in full-stack development.
								I enjoy exploring new technologies to expand my skills.
							</span>
						</div>
						<div className="mt-4">
							<Button as={HashLink} to="#contact" variant="dark" className="m-3 p-2">
								Get in touch
							</Button>
							<Button as={HashLink} to="#projects" variant="outline-dark m-3 p-2">
								Projects
							</Button>
						</div>
					</Col>
